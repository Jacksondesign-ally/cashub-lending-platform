...
ALTER TABLE borrower_disputes ADD COLUMN IF NOT EXISTS borrower_id UUID REFERENCES borrowers(id) ON DELETE SET NULL;
ALTER TABLE borrower_disputes ADD COLUMN IF NOT EXISTS lender_id UUID REFERENCES lenders(id) ON DELETE SET NULL;
...
CREATE POLICY IF NOT EXISTS "Allow all for authenticated" ON borrower_documents FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow all for anon" ON borrower_documents FOR ALL TO anon USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow all for authenticated" ON loan_agreements FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow all for anon" ON loan_agreements FOR ALL TO anon USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow all for authenticated" ON compliance_requirements FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow all for anon" ON compliance_requirements FOR ALL TO anon USING (true) WITH CHECK (true);
