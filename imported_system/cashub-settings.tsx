            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-xl border border-white/20 p-8">
              ...
              {activeTab === 'backup' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-6">
                    ...
                    <p className="text-red-200 text-sm mb-4">These actions cannot be undone. Please be careful.</p>
                    <button className="px-4 py-3 bg-red-600 hover:bg-red-700 rounded-lg text-white font-medium transition-all flex items-center gap-2">
                      <Trash2 size={18} />
                      Delete All Data
                    </button>
                  </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-white/20 mt-8">
                ...
                <div className="flex gap-3 ml-auto">
                  <button className="px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg text-white font-medium transition-all">
                    Cancel
                  </button>
                  <button 
                    onClick={handleSave}
...
export default SettingsPanel; border border-white/20 rounded-lg text-white font-medium transition-all flex items-center justify-between">
